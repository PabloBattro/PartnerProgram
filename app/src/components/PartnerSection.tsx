    ...
    <div className="space-y-20">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">{t('partner.title')}</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">{t('partner.subtitle')}</p>
        </div>

        {/* Why Partner */}
        <h3 className="text-2xl font-bold text-gray-900 text-center mb-8">{t('partner.whyTitle')}</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          <Card>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">{t('partner.why1Desc')}</p>
            </div>
          </Card>
          <Card>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">{t('partner.why2Desc')}</p>
            </div>
          </Card>
          <Card>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">{t('partner.why3Desc')}</p>
            </div>
          </Card>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h3 className="text-2xl font-bold text-gray-900 text-center mb-12">{t('partner.howTitle')}</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map((i) => (
              <div key={i} className="text-center">
                ...
                <p className="text-gray-600">{t(`partner.how${i}Desc`)}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Partner Categories */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h3 className="text-2xl font-bold text-gray-900 text-center mb-12">{t('partner.categoriesTitle')}</h3>
            ...
            <Card key={i} className="hover:shadow-lg transition-shadow">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">{t(`partner.cat${i}Desc`)}</p>
                </div>
              </div>
            </Card>
          ))}
      ...
      {/* Partner Form */}
      <section className="bg-gray-50 py-16" id="partner-form">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <h3 className="text-2xl font-bold text-gray-900 text-center mb-8">{t('partner.formTitle')}</h3>
